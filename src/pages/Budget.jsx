...
import {   Container, Text, VStack, Box, Flex, Icon, HStack } from "@chakra-ui/react";
          ...
          <Box>
            ...
            >
              <Flex gap={2}>
                ...
                <VStack>
                  <Text fontSize={['.6em', '1em']} fontWeight='300' display="block" 
                    _hover={{
                      color: [ "gray.600"]
                    }}
                  >
              ...
              <Flex>
                <Text fontSize={['.8em', '1.3em']} fontWeight='300' display="block"
                  color='#0466C8' 
                  _hover={{
                    color: [ "gray.600"]
                  }}
